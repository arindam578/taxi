...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'hospitaler' => \App\Http\Middleware\RedirectIfNotHospitaler::class,
        'hospitaler.guest' => \App\Http\Middleware\RedirectIfHospitaler::class,
        ...
        'fleet.api' => \App\Http\Middleware\FleetApiMiddleware::class,
