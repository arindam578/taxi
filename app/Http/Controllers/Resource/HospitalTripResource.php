...
class HospitalTripResource extends Controller
{
        ...
        try {
            ...
            if(Auth::guard('admin')->user()){
               return view('admin.request.index', compact('requests','page'));
                ...
                return view('hospitaler.request.index', compact('requests'));
            }
    ...
    public function scheduled()
    {
        try{
            ...
            if(Auth::guard('admin')->user()){
                ...
                return view('hospitaler.request.scheduled', compact('requests'));
            }
