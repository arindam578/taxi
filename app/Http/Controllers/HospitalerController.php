...
class HospitalerController extends Controller
{
    ...
    public function index()
    {
        if(Auth::guard('admin')->user()){
            return view('admin.hospitaler');
        }elseif(Auth::guard('hospitaler')->user()){
            return view('hospitaler.auth.hospitaler');
        }
    }
    ...
    public function assign($request_id, $provider_id)
    {
        try {
            ...
            if(Auth::guard('admin')->user()){
                return redirect()
                        ->route('admin.hospitaler.index')
                        ->with('flash_success', 'Request Assigned to Provider!');

            }elseif(Auth::guard('hospitaler')->user()){
                return redirect()
                        ->route('hospitaler.index')
                        ->with('flash_success', 'Request Assigned to Provider!');
            ...
            if(Auth::guard('admin')->user()){
                return redirect()->route('admin.hospitaler.index')->with('flash_error', 'Something Went Wrong!');
            }elseif(Auth::guard('hospitaler')->user()){
                return redirect()->route('hospitaler.index')->with('flash_error', 'Something Went Wrong!');
            }
        }
    }
...
//dd($total_days);
    ...
    {
        //$data  = DB::table('hospitalers')->find($id);
        try {
            $hospitaler = Hospitaler::findOrFail($id);

            if(Auth::guard('hospitaler')->user()){
                return view('hospitaler.account.profile',compact('hospitaler')); 
            } 
            
        } catch (ModelNotFoundException $e) {
            return $e;
        }
        //return view('hospitaler.account.profile', ['data'=>$data]);
    }
    ...
    public function profile_update(Request $request, $id)
    {
        ...
        try{
            $hospitaler = Auth::guard('hospitaler')->user();
    ...
    {
        return view('hospitaler.account.change-password');
    }
    ...
    public function password_update(Request $request)
    {
        ...
        try {
           ...
           $Hospitaler = Hospitaler::find(Auth::guard('hospitaler')->user()->id);

            if(password_verify($request->old_password, $Hospitaler->password))
            {
...
///// admin function
    ...
    public function dashboard()
    {
        try{
            ...
            return view('hospitaler.dashboard',compact('providers','fleet','scheduled_rides','service','rides','user_cancelled','provider_cancelled','cancel_rides','revenue'));
        }
        catch(Exception $e){
            return redirect()->route('hospitaler.user.index')->with('flash_error','Something Went Wrong with Dashboard!');
        }
    }
    ...
    public function heatmap()
    {
        try{
            $rides = UserRequests::has('user')->orderBy('id','desc')->get();
            $providers = Provider::take(10)->orderBy('rating','desc')->get();
            return view('hospitaler.heatmap',compact('providers','rides'));
        }
        catch(Exception $e){
            return redirect()->route('hospitaler.user.index')->with('flash_error','Something Went Wrong with Dashboard!');
        }
    ...
    { 
        if(isset($request->name))
            ...
            $name = ''; 
        return view('hospitaler.map.index',compact('name'));
    }
    ...
    public function payment()
    {
        try {
            ...
            return view('hospitaler.payment.payment-history', compact('payments'));
        } catch (Exception $e) { 
             return back()->with('flash_error','Something Went Wrong!');
        }
    }
    ...
    public function user_review()
    {
            ...
            return view('hospitaler.review.user_review',compact('Reviews'));
    ...
    public function provider_review()
    {
            ...
            return view('hospitaler.review.provider_review',compact('Reviews'));
    ...
    public function privacy(){
        return view('hospitaler.pages.static')
    ...
    public function terms(){
        return view('hospitaler.pages.terms')
            ->with('title',"Terms & Condition Page")
            ->with('page', "terms");
    }

    public function offers(){
        return view('hospitaler.pages.offers')
            ->with('title',"Offers")
            ->with('page', "offers");
    }
     ...
     public function about_us(){
        return view('hospitaler.pages.about_us')
            ->with('title',"About Us")
            ->with('page', "about_us");
    }
    ...
    public function statement($type = 'individual'){
        ...
        try{
            ...
            return view('hospitaler.providers.statement', compact('rides','cancel_rides','revenue'))
                    ->with('page',$page);
    ...
    public function statement_provider(){
        ...
        try{
            ...
            return view('hospitaler.providers.provider-statement', compact('Providers'))->with('page','Providers Statement');
    ...
    public function translation(){
        ...
        try{
            return view('hospitaler.translation');
        }
    ...
    public function push(){
        ...
        try{
            ...
            return view('hospitaler.push',compact('Pushes'));
        }
