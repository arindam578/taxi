...
<head>
    ...
    <!-- Title -->
    <title>@yield('title'){{ Setting::get('site_title', 'Tranxit') }} - Hospitaler Panel</title>
...
<body class="fixed-sidebar fixed-header content-appear skin-default">
    ...
    <div class="wrapper">
        ...
        @include('hospitaler.include.nav')

        @include('hospitaler.include.header')
        ...
        <div class="site-content">
            ...
            @include('hospitaler.include.footer')
