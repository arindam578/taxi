@extends('hospitaler.layout.auth')
    ...
    <div class="row">
        <div class="col-md-4 offset-md-4 px-3">
            <div class="box b-a-0">
                ...
                <form class="form-material mb-1" role="form" method="POST" action="{{ url('/hospitaler/login') }}" >
                {{ csrf_field() }}
                ...
                <div class="p-2 text-xs-center text-muted">
                    <a class="text-black" href="{{ url('/hospitaler/password/reset') }}"><span class="underline">Forgot Your Password?</span></a>
                </div>
            </div>
        </div>
    </div>
