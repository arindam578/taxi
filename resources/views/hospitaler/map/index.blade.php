...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="box box-block bg-white">
            ...
            <div class="row">
                <div class="col-xs-4">
                     <input type="text" class=" col-md-3 form-control pull-right" id="search_name" placeholder="Enter Name">
                </div>
                <div class="col-xs-4">
...
<script>
    ...
    function ajaxMapData() {
        map.clearOverlays();
        $.ajax({
            url: '/dispatcher/map/ajax?name={{$name}}',
            dataType: "JSON",
        ...
        $(document).ready(function(){ 
            $("#search_submit").click(function(event){
               var name = $("#search_name").val();  
                window.location = "/dispatcher/map?name=" + name;
            }); 
        });
    }
