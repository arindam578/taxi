<div class="site-sidebar">
	<div class="custom-scroll custom-scroll-light">
		<ul class="sidebar-menu">
			<li class="menu-title">Hospital Dashboard</li>
			
			{{--<li>
				<a href="{{ route('hospitaler.dashboard') }}" class="waves-effect waves-light">
			...
			<li>
				<a href="{{ url('hospitaler') }}" class="waves-effect waves-light">
					<span class="s-icon"><i class="ti-target"></i></span>
					<span class="s-text">Hospital Panel</span>
				</a>
			</li>


			<li>
				<a href="{{ route('heatmap') }}" class="waves-effect waves-light">
			...
			<li>
				<a href="{{ route('map.index') }}" class="waves-effect waves-light">
			...
			<li class="with-sub">
				...
				<ul>
					<li><a href="{{ route('user.review') }}">@lang('admin.include.user_ratings')</a></li>
					<li><a href="{{ route('review') }}">@lang('admin.include.provider_ratings')</a></li>
				</ul>
			</li>
			<li class="menu-title">@lang('admin.include.requests')</li>
			<li>
				<a href="{{ route('requests.index') }}" class="waves-effect  waves-light">
					<span class="s-icon"><i class="ti-infinite"></i></span>
					<span class="s-text">@lang('admin.include.request_history')</span>
				</a>
			</li>
			<li>
				<a href="{{ route('requests.scheduled') }}" class="waves-effect  waves-light">
			...
			<li class="compact-hide">
                ...
                <form id="logout-form" action="{{ url('/hospitaler/logout') }}" method="POST" style="display: none;">
                    {{ csrf_field() }}
                </form>
			</li>
