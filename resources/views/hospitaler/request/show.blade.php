...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <a href="{{ route('dispatcher.requests.index') }}" class="btn btn-default pull-right">
            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">
                            @if(@$request->user)
                            <a href="{{url('dispatcher/user/'.$request->user->id)}}">{{ $request->user?@$request->user->first_name:'' }}</a>
                            @else
                            N/A
                            @endif
                        </dd>
                        ...
                        @if($request->provider)
                        <dd class="col-sm-8"><a href="{{url('dispatcher/provider/'.$request->provider->id)}}">{{ $request->provider?$request->provider->first_name:'' }}</a></dd>
                        @else
