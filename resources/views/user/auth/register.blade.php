...
<?php $login_user = asset('asset/img/bg.jpg'); ?>
<div class="full-page-bg" style="background-image: url({{ asset('asset/img/bg_one.jpg') }});">
...
<script>
  ...
  function smsLogin() {
        ...
        $.post("{{route('user.check.mobile')}}",{ username : phoneNumber }, function(data){
