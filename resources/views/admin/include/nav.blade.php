<div class="site-sidebar">
	<div class="custom-scroll custom-scroll-light">
		<ul class="sidebar-menu">
			...
			<li>
				<a href="{{route('ecommerce')}}" class="waves-effect waves-light">
					<span class="s-icon"><i class="ti-anchor"></i></span>
					<span class="s-text">Visit Ecommerce Admin</span>
				</a>
			</li>
			<?php
				 }
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-crown"></i></span>
					<span class="s-text">Hospital</span>
				</a>
				<ul>
					<?php
					 $hospitaler_view = check_permission('hospitaler_view',Auth::user()->role_id);
					 if($hospitaler_view==1)  {
					 ?>
					<li><a href="{{ route('admin.hospital-manager.index') }}">List Hospital</a></li>
					<?php 
					 } 
					 $hospitaler_create = check_permission('hospitaler_create',Auth::user()->role_id);
					 if($hospitaler_create==1)  {
					 ?>
					<li><a href="{{ route('admin.hospital-manager.create') }}">Add New Hospital</a></li>
