            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-6 col-md-offset-3 col-md-8 col-md-offset-2">
                ...
                <div id="userform">
                    <ul class="nav nav-tabs nav-justified" role="tablist">
                        ...
                        <li @if ($errors->has('login_type') && $errors->first('login_type') == 'hospital')  class="active" @endif><a href="#hospital" role="tab" data-toggle="tab">Hospital</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade @if ($errors->has('login_type') && $errors->first('login_type') == 'fleet')  active @endif in" id="fleet">
                         ...
                         <!-- Fleet -->
                         <!--Hospital-->
                         <div class="tab-pane fade @if ($errors->has('login_type') && $errors->first('login_type') == 'hospitaler')  active @endif in" id="hospital">
                            <h2 class="text-uppercase text-center">Sign In</h2>
                            <form id="login" role="form" method="POST" action="{{url('/hospitaler/login') }}">
                             {{ csrf_field() }}
                                <div class="form-group">
                                    <label>Hospital Administrator E-mail<span class="req">*</span> </label>
                                        <input type="email" name="email" class="form-control" id="email" required data-validation-required-message="Please enter your email address." autocomplete="off">
                                        @if ($errors->has('email'))
                                            <p class="help-block text-danger">{{ $errors->first('email') }}</p>
                                        @endif
