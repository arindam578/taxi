...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;">Add Hospital</h5>

            <form class="form-horizontal" action="{{route('admin.hospital-manager.store')}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
				...
				<div class="form-group row">
					<label for="email" class="col-xs-12 col-form-label">@lang('admin.address')</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" required name="address" value="{{old('address')}}" id="address" placeholder="Address">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						...
						<a href="{{route('admin.hospital-manager.index')}}" class="btn btn-default">@lang('admin.cancel')</a>
					</div>
				</div>
			</form>
		</div>
